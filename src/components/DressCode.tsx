...
export default function DressCode() {
  return (
    <section className="w-full max-w-sm mx-auto px-5 py-4 text-center flex flex-col gap-10">
      {[28, 32, 34, 36].map((size) => (
        <div key={size} className="w-full relative">
          <p className="font-sans text-[10px] text-foreground/40 mb-2 uppercase tracking-widest">
            Título {size}px
          </p>
          <motion.h2
            initial={{ opacity: 0 }}
            ...
            className="font-serif text-gold mb-4 leading-tight"
          >
